...
contract sOlympus is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Olympus", "sPIP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPIP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPIP
